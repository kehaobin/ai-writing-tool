# app.py - AI作文辅助系统（最终修复版：解决重复输入模型名称问题）
import json
import requests
...
# ✅ 核心修复：只在主进程执行一次输入，避免Flask重启导致重复输入
if os.environ.get('WERKZEUG_RUN_MAIN') is None:
    ai = input("请输入模型名称：")
    MODEL_NAME = ai
else:
    MODEL_NAME = os.environ.get('MODEL_NAME', 'essay-teacher')
...
if __name__ == '__main__':
    ...
    print("💡 功能：")
    print("   - 手动输入作文分析")
    print("   - 生成大纲 | 搜集素材 | 生成范文")
    print("   - 检查错字 | 文章润色 | 作文改写")
    print("=" * 60)
